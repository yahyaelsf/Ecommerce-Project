                                                ...
                                                @if(get_languages() -> count() > 0)
                                                    @foreach(get_languages() as $index => $lang)
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label for="projectinput1"> اسم القسم - {{__('message.'.$lang -> abdr)}} </label>
                                                            ...
                                                            <div class="col-md-6 hidden">
                                                                <div class="form-group">
                                                                    <label for="projectinput1"> أختصار اللغة {{__('message.'.$lang -> abdr)}} </label>
                                                                    <input type="text" id="abdr"
                                                                           class="form-control"
                                                                           placeholder="  "
                                                                           value="{{$lang -> abdr}}"
                                                                           name="category[{{$index}}][abdr]">

                                                                    @error("category.$index.abdr")
                                                                    <span class="text-danger"> هذا الحقل مطلوب</span>
                                                                    @enderror
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group mt-1">
                                                                    ...
                                                                    <label for="switcheryColor4"
                                                                           class="card-title ml-1">الحالة  {{__('message.'.$lang -> abdr)}} </label>
